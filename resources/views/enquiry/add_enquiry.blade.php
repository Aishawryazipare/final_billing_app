            ...
            <div class="box" style="border-top: 3px solid #ffffff;">
                ...
                <form class="form-horizontal" id="userForm" method="post" action="{{ url('add-enquiry') }}">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="gst" class="col-sm-2 control-label">Enquiry Status<span style="color:red"> * </span></label>
                            <div class="col-sm-4">
                        ...
                        <table style="margin: 10px 10px 10px 10px;" class="table" >
                            <tbody id="h_lost">                                
                                <tr class="first">
                                    <td>
                                        <textarea class="form-control mobile_date" rows="3" placeholder="Enter Here..." name="follow_up[0][0]"  ></textarea>   
                                    </td>
                                    <td>
                            ...
                            <div class="col-sm-4">
                                <!--<input type="text" class="form-control " id="user" placeholder="City" value="" name="city_id"  >-->
									...
									<datalist id="browsers">
										@foreach($city as $c)
										<option value="{{$c->city_name}}" <?php if(isset($location)){ if($location == $c->city_id) echo "selected"; }?>>{{$c->city_name}}</option>
                                       @endforeach
									</datalist>
