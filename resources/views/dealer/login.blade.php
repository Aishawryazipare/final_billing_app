...
<div class="login-box">
  <div class="login-logo">
    <a href="/" style="color:white;"><b>Dealer Billing</b> App</a>
  </div>
<!--    <div class="" style="text-align: center;">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Log in to start your session</p>
        ...
        <form method="POST" action="{{ url('dealer-login') }}" aria-label="{{ __('Login') }}">
                            @csrf
<div class="form-group has-feedback {{ $errors->has('dealer_mobile_no') ? ' has-error' : '' }}">
    <input type="text" id="dealer_mobile_no" name="dealer_mobile_no" class="form-control" placeholder="Mobile" value="{{ Cookie::get('mobile_no') }}">
